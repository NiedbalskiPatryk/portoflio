...
export default function EcommerceEditorial() {
  const t = useTranslations("showRoomProjects.ecommerce.editorial");
  const collections = t.raw("collections") as Array<{ title: string; description: string }>;
  const editorialLooks = t.raw("looks") as Array<{
    id: string;
    title: string;
    subtitle: string;
    image: string;
