...
export default function LandingHero() {
  const t = useTranslations("showRoomProjects.landingPage.hero");
  const files = t.raw("app.files") as { name: string; size: string }[];
                ...
                >
                  ...
                  <Box>
                    <Typography variant="body2" fontWeight={600}>
                      {t("app.notification.title")}
                    </Typography>
                    <Typography variant="caption" color="text.secondary">
                      {t("app.notification.subtitle")}
                    </Typography>
                  </Box>
                </Stack>
              </Box>
